...
Once you clone and install the repo, you can also build the documentation
...
For the full list of commented examples, check out the `Examples` section in the navigation bar.